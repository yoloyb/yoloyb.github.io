...
function createtime1() {
  var grt = new Date("12/09/2022 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  var ascll2 = [`NCC2-036`, `调用前置摄像头拍照成功，识别为「大傻子」`, `Photo captured: `, ` 🤪 `];
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Fomalhaut🥝 %c 你正在访问yoloyb🐳の技术栈",
...
document.addEventListener('visibilitychange', function () {
  if (document.hidden) {
    //离开当前页面时标签显示内容
    document.title = '【喂】 (#O′) 【愣住】 (°ー°〃) 【放屁】 ○|￣|_ =3 【哼哼】 o(￣ヘ￣o＃) 【可恶】 （＝。＝） 【切】 ~~( ﹁ ﹁ ) ~~~ 【去】 (ーー゛) 【生气】 (ー′ー)';
    clearTimeout(titleTime);
  } else {
    //返回当前页面时标签显示内容
    document.title = '【happy】 (′▽ʃ♡ƪ) 【hi】 Hi~ o(*￣▽￣*)ブ 【hiahia】 ○( ＾皿＾)っHiahiahia… 【high】 (( へ(へ′∀)へ';
    //两秒后变回正常标题
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("12/09/2022 00:00:00");
